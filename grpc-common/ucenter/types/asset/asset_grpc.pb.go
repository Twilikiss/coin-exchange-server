...
const (
	Asset_FindWalletBySymbol_FullMethodName = "/asset.Asset/findWalletBySymbol"
	Asset_FindWallet_FullMethodName         = "/asset.Asset/findWallet"
	Asset_ResetAddress_FullMethodName       = "/asset.Asset/resetAddress"
	Asset_FindAllTransaction_FullMethodName = "/asset.Asset/findAllTransaction"
	Asset_GetAddress_FullMethodName         = "/asset.Asset/getAddress"
)
...
func (c *assetClient) FindWalletBySymbol(ctx context.Context, in *AssetReq, opts ...grpc.CallOption) (*MemberWallet, error) {
	...
	err := c.cc.Invoke(ctx, Asset_FindWalletBySymbol_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetClient) FindWallet(ctx context.Context, in *AssetReq, opts ...grpc.CallOption) (*MemberWalletList, error) {
	...
	err := c.cc.Invoke(ctx, Asset_FindWallet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetClient) ResetAddress(ctx context.Context, in *AssetReq, opts ...grpc.CallOption) (*RestAddrResp, error) {
	out := new(RestAddrResp)
	err := c.cc.Invoke(ctx, Asset_ResetAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetClient) FindAllTransaction(ctx context.Context, in *AssetReq, opts ...grpc.CallOption) (*MemberTransactionList, error) {
	out := new(MemberTransactionList)
	err := c.cc.Invoke(ctx, Asset_FindAllTransaction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetClient) GetAddress(ctx context.Context, in *AssetReq, opts ...grpc.CallOption) (*AddressList, error) {
	out := new(AddressList)
	err := c.cc.Invoke(ctx, Asset_GetAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AssetServer interface {
	...
	ResetAddress(context.Context, *AssetReq) (*RestAddrResp, error)
	FindAllTransaction(context.Context, *AssetReq) (*MemberTransactionList, error)
...
func (UnimplementedAssetServer) ResetAddress(context.Context, *AssetReq) (*RestAddrResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResetAddress not implemented")
}
func (UnimplementedAssetServer) FindAllTransaction(context.Context, *AssetReq) (*MemberTransactionList, error) {
...
func _Asset_FindWalletBySymbol_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Asset_FindWalletBySymbol_FullMethodName,
	}
...
func _Asset_FindWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Asset_FindWallet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Asset_ResetAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Asset_ResetAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Asset_FindAllTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssetReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssetServer).FindAllTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Asset_FindAllTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssetServer).FindAllTransaction(ctx, req.(*AssetReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Asset_GetAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Asset_GetAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Asset_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Asset_FindAllTransaction_Handler,
		},
		{
