...
func (m *defaultRegister) SendCode(ctx context.Context, in *CodeRes, opts ...grpc.CallOption) (*NoRes, error) {
	client := register.NewRegisterClient(m.cli.Conn())
