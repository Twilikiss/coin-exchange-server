...
const (
	Withdraw_FindAddressByCoinId_FullMethodName = "/withdraw.Withdraw/findAddressByCoinId"
	Withdraw_SendCode_FullMethodName            = "/withdraw.Withdraw/SendCode"
	Withdraw_WithdrawCode_FullMethodName        = "/withdraw.Withdraw/WithdrawCode"
...
func (c *withdrawClient) FindAddressByCoinId(ctx context.Context, in *WithdrawReq, opts ...grpc.CallOption) (*AddressSimpleList, error) {
	...
	err := c.cc.Invoke(ctx, Withdraw_FindAddressByCoinId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *withdrawClient) WithdrawCode(ctx context.Context, in *WithdrawReq, opts ...grpc.CallOption) (*NoRes, error) {
	out := new(NoRes)
	err := c.cc.Invoke(ctx, Withdraw_WithdrawCode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Withdraw_FindAddressByCoinId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Withdraw_FindAddressByCoinId_FullMethodName,
	}
...
func _Withdraw_WithdrawCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Withdraw_WithdrawCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
